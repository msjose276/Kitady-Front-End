    ...
    actions: {
      requestCard: function () {
        ...
        let newRecord = this.store.createRecord('request', {
          ...
          "message": message
        }).save().then(alert('Pedido Enviado')).catch(function (reason) {
