...
define('front-end-kitady/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('routes/index.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/index.js should pass ESLint\n\n19:11 - \'newRecord\' is assigned a value but never used. (no-unused-vars)');
  });
});
